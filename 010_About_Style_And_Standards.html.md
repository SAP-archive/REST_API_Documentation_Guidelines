...
<img src="img/smiley.png" style="float:left;width:10px;height:10px;"> The endpoint path includes your service name.<br>
<img src="img/frowny.png" style="float:left;width:10px;height:10px;"> Your service name is to be included in the endpoint path.
