...
<img src="img/smiley.png" style="float:left;width:42px;height:42px;"> The endpoint path includes your service name.
<img src="img/frowny.png" style="float:left;width:42px;height:42px;"> Your service name is to be included in the endpoint path.
