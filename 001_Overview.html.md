...
This guide explains the documentation requirements and provides guidelines to ensure your documentation follows the <a href="#AbouttheStyleandStandards">Style and Standards</a>.
...
Voice and tone standards apply to the different areas of documentation platforms. First, it is important to understand the difference between voice and tone, and then follow the guidelines for writing content in the proper tone, depending on the destination for your documentation.
</p>
